  ...
  return (
    <>
      ...
      <main className='grid grid-cols-3 gap-5 -mt-36 mx-auto w-[98%] z-10 relative lg:grid-cols-4 pb-5'>
        <Card title="Top Deals" category="" img={<img src={deals} alt="deals" />} linkTitle="See all the deals" to="/productList" />
        <Card title="Electronics" category="Electronics" img={<img src={electronics} alt="electronics" />} linkTitle="See more" to="/productList" />
        <Card title="Shoes" category="Shoes" img={<img src={shoes} alt="shoes" />} linkTitle="Shop now" to="/productList" />
        <Card title="Books" category="Books" img={<img src={books} alt="books" />} linkTitle="Shop now" to="/productList" />
